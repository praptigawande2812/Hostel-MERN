...
import WashingMachine from './components/Dashboards/StudentDashboard/WashingMachine';
import AdminWashingMachine from './components/Dashboards/AdminDashboard/WashingMachine';
    ...
    <>
      <Routes>
        ...
        <Route path="/admin-dashboard" element={<AdminIndex />}>
          ...
          <Route path="washing-machine" element={<AdminWashingMachine />} />
        </Route>
      </Routes>
    </>
  );
