...
const getHostel = async (req, res) => {
    try {
        ...
        if (!admin.hostel) {
            console.log('Admin has no hostel assigned');
            return res.status(400).json({success, errors: [{msg: 'No hostel assigned to this admin'}]});
        }

        console.log('Looking for hostel with ID:', admin.hostel);
