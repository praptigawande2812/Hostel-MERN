...
const { requestMessOff, countMessOff, listMessOff, updateMessOff, registerMessOff, getMessOff, getAllMessOffRequests } = require('../controllers/messoffController');
...
// @route   GET api/messoff/all
// @desc    Get all mess off requests
// @access  Private
router.get('/all', getAllMessOffRequests);
